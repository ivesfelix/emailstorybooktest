import{j as n}from"./jsx-runtime-Dob27XW0.js";import{r as a}from"./index-uubelm5h.js";localStorage.getItem("sb-color-scheme");const p={actions:{argTypesRegex:"^on[A-Z].*"},controls:{expanded:!0},docs:{source:{language:"html"}},backgrounds:{disable:!0},toolbar:{title:{hidden:!1},zoom:{hidden:!1},eject:{hidden:!1},copy:{hidden:!1},fullscreen:{hidden:!1},viewport:{hidden:!1},"z-color-scheme-toggle/tool":{hidden:!1}},viewport:{viewports:{iphone5:{name:"iPhone 5",styles:{width:"320px",height:"568px"},type:"mobile",icon:"mobile"},iphone14pro:{name:"iPhone 14 Pro",styles:{width:"393px",height:"852px"},type:"mobile",icon:"mobile"},desktop:{name:"Desktop",styles:{width:"1024px",height:"1280px"},type:"desktop",icon:"browser"}}},html:{prettier:{tabWidth:2,useTabs:!1,htmlWhitespaceSensitivity:"ignore",printWidth:80,proseWrap:"always"},highlighter:{wrapLines:!0,showLineNumbers:!1},removeComments:!1,removeEmptyComments:!1}},m={colorScheme:{defaultValue:"light"}},c=[(s,i)=>{const r=i.globals.colorScheme||"light";return a.useEffect(()=>{const t="custom-html-addon-styles";let o=document.getElementById(t);o||(o=document.createElement("style"),o.id=t,document.head.appendChild(o)),o.textContent=`
