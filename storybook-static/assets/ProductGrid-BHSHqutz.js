    ...
    <tr>
        <td style="padding: 0 32px ${o?"24px":"40px"} 32px;" class="${o?"mobile-padding-grid":"mobile-padding-grid-no-cta"}">
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                ...
                <tr>
                    <!-- Grid 1 -->
                    <td width="50%" style="padding: 0 12px ${t>1?"24px":"0"} 0;" class="grid-item-left">
                        <a href="#" style="text-decoration: none; display: block;">
                            <img src="${c}" alt="Grid" style="border-radius: 8px; clear: both; display: block; width: 100%; height: auto; object-fit: cover; object-position: center; outline: none; text-decoration: none; border: 0; aspect-ratio: 1;" />
                        </a>
                        ${e?`
                    ...
                    <!-- Grid 2 -->
                    <td width="50%" style="padding: 0 0 ${t>1?"24px":"0"} 12px;" class="grid-item-right">
                        <a href="#" style="text-decoration: none; display: block;">
                            <img src="${d}" alt="Grid" style="border-radius: 8px; clear: both; display: block; width: 100%; height: auto; object-fit: cover; object-position: center; outline: none; text-decoration: none; border: 0; aspect-ratio: 1;" />
                        </a>
                        ${e?`
                        <div style="padding-top: 8px;">
                ...
                <tr>
                    <!-- Grid 3 -->
                    <td width="50%" style="padding: 0 12px ${t>2?"24px":"0"} 0;" class="grid-item-bottom-left">
                        <a href="#" style="text-decoration: none; display: block;">
                            <img src="${p}" alt="Grid" style="border-radius: 8px; clear: both; display: block; width: 100%; height: auto; object-fit: cover; object-position: center; outline: none; text-decoration: none; border: 0; aspect-ratio: 1;" />
                        </a>
                        ${e?`
                        <div style="padding-top: 8px;">
                    ...
                    <!-- Grid 4 -->
                    <td width="50%" style="padding: 0 0 ${t>2?"24px":"0"} 12px;" class="grid-item-bottom-right">
                        <a href="#" style="text-decoration: none; display: block;">
                            <img src="${f}" alt="Grid" style="border-radius: 8px; clear: both; display: block; width: 100%; height: auto; object-fit: cover; object-position: center; outline: none; text-decoration: none; border: 0; aspect-ratio: 1;" />
                        </a>
                        ${e?`
                        <div style="padding-top: 8px;">
                            ...
                            <p style="margin: 0; font-family: 'ABC Diatype', 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.3; color: #312b36;">${A}</p>
                        </div>
                        `:""}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="50%" style="padding: 0 12px 0 0;" class="grid-item-last-left">
                        ...
                        <div style="padding-top: 8px;">
                            <p style="margin: 0 0 4px 0; font-family: 'ABC Diatype', 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.3; color: #312b36; font-weight: 500;">${H}</p>
                            <p style="margin: 0; font-family: 'ABC Diatype', 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.3; color: #312b36;">${j}</p>
                        </div>
                        `:""}
                    </td>
                    <!-- Grid 6 -->
